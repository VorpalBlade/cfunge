...
/* Prototypes */
static inline void              CF_GHT_NAME(CF_GHT_VAR, transpose) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht, ght_uint32_t l_bucket, CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *p_entry) FUNGE_ATTR_FAST;
static inline void              CF_GHT_NAME(CF_GHT_VAR, move_to_front) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht, ght_uint32_t l_bucket, CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *p_entry) FUNGE_ATTR_FAST;
static inline void              CF_GHT_NAME(CF_GHT_VAR, free_entry_chain) (CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *p_entry) FUNGE_ATTR_FAST;
static inline CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *CF_GHT_NAME(CF_GHT_VAR, search_in_bucket) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht, ght_uint32_t l_bucket, CF_GHT_NAME(CF_GHT_VAR, hash_key_t) *p_key, const unsigned char i_heuristics) FUNGE_ATTR_FAST;

static inline void              CF_GHT_NAME(CF_GHT_VAR, hk_fill) (CF_GHT_NAME(CF_GHT_VAR, hash_key_t) *p_hk, const CF_GHT_KEY *p_key) FUNGE_ATTR_FAST;
static inline CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *CF_GHT_NAME(CF_GHT_VAR, he_create) (CF_GHT_DATA p_data, const CF_GHT_KEY *p_key_data) FUNGE_ATTR_FAST;
static inline void              CF_GHT_NAME(CF_GHT_VAR, he_finalize) (CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *p_he) FUNGE_ATTR_FAST;

/* --- private methods --- */

/* Move p_entry one up in its list. */
FUNGE_ATTR_FAST
static inline void CF_GHT_NAME(CF_GHT_VAR, transpose) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht, ght_uint32_t l_bucket,
...
/* Move p_entry first */
FUNGE_ATTR_FAST
static inline void CF_GHT_NAME(CF_GHT_VAR, move_to_front) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht, ght_uint32_t l_bucket,
                                 CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *p_entry)
{
	/*
	 *  __    __    __
...
FUNGE_ATTR_FAST
static inline void CF_GHT_NAME(CF_GHT_VAR, remove_from_chain) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht,
                                     ght_uint32_t l_bucket, CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *p)
{
	if (p->p_prev) {
...
FUNGE_ATTR_FAST
static inline bool CF_GHT_NAME(CF_GHT_VAR, CompareKeys) (const CF_GHT_NAME(CF_GHT_VAR, hash_key_t) * restrict a,
...
FUNGE_ATTR_FAST
static inline CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *CF_GHT_NAME(CF_GHT_VAR, search_in_bucket) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht,
...
FUNGE_ATTR_FAST static inline void CF_GHT_NAME(CF_GHT_VAR, free_entry_chain) (CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *p_entry)
{
...
FUNGE_ATTR_FAST static inline void CF_GHT_NAME(CF_GHT_VAR, hk_fill) (CF_GHT_NAME(CF_GHT_VAR, hash_key_t) *p_hk,
...
FUNGE_ATTR_FAST
static inline CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *CF_GHT_NAME(CF_GHT_VAR, he_create) (CF_GHT_DATA p_data,
...
FUNGE_ATTR_FAST static inline void CF_GHT_NAME(CF_GHT_VAR, he_finalize) (CF_GHT_NAME(CF_GHT_VAR, hash_entry_t) *p_he)
{
	assert(p_he != NULL);
...
FUNGE_ATTR_FAST CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *CF_GHT_NAME(CF_GHT_VAR, create) (size_t i_size)
{
	...
	if (!(p_ht->pp_entries = (CF_GHT_NAME(CF_GHT_VAR, hash_entry_t)**)cf_malloc(p_ht->i_size * sizeof(CF_GHT_NAME(CF_GHT_VAR, hash_entry_t)*)))) {
		perror("malloc");
		cf_free(p_ht);
		return NULL;
	}
	memset(p_ht->pp_entries, 0, p_ht->i_size*sizeof(CF_GHT_NAME(CF_GHT_VAR, hash_entry_t)*));
...
FUNGE_ATTR_FAST void CF_GHT_NAME(CF_GHT_VAR, set_rehash) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht, bool b_rehash)
{
...
FUNGE_ATTR_FAST
static inline void *CF_GHT_NAME(CF_GHT_VAR, first_keysize) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht,
...
void *CF_GHT_NAME(CF_GHT_VAR, first) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht,
                CF_GHT_NAME(CF_GHT_VAR, iterator_t) *p_iterator, const CF_GHT_KEY **pp_key)
{
	return CF_GHT_NAME(CF_GHT_VAR, first_keysize) (p_ht, p_iterator, pp_key, NULL);
}

FUNGE_ATTR_FAST
static inline void *CF_GHT_NAME(CF_GHT_VAR, next_keysize) (CF_GHT_NAME(CF_GHT_VAR, iterator_t) *p_iterator,
                                 const CF_GHT_KEY **pp_key, size_t *size)
{
...
FUNGE_ATTR_FAST
void *CF_GHT_NAME(CF_GHT_VAR, next) (CF_GHT_NAME(CF_GHT_VAR, iterator_t) *p_iterator, const CF_GHT_KEY **pp_key)
{
 ...
 */
FUNGE_ATTR_FAST void CF_GHT_NAME(CF_GHT_VAR, rehash) (CF_GHT_NAME(CF_GHT_VAR, hash_table_t) *p_ht, size_t i_size)
{
