...
FUNGE_ATTR_FAST
static inline void transpose(ght_hash_table_t *p_ht, ght_uint32_t l_bucket,
...
/* Move p_entry first */
FUNGE_ATTR_FAST
static inline void move_to_front(ght_hash_table_t *p_ht, ght_uint32_t l_bucket,
                                 ght_hash_entry_t *p_entry)
{
	/*
	 *  __    __    __
...
FUNGE_ATTR_FAST
static inline void remove_from_chain(ght_hash_table_t *p_ht,
                                     ght_uint32_t l_bucket, ght_hash_entry_t *p)
{
	if (p->p_prev) {
...
FUNGE_ATTR_FAST
static inline bool CompareKeys(const ght_hash_key_t * restrict a,
                               const ght_hash_key_t * restrict b)
{
...
FUNGE_ATTR_FAST
static inline ght_hash_entry_t *search_in_bucket(ght_hash_table_t *p_ht,
...
FUNGE_ATTR_FAST static inline void hk_fill(ght_hash_key_t *p_hk,
...
FUNGE_ATTR_FAST
static inline void *first_keysize(ght_hash_table_t *p_ht,
                                  ght_iterator_t *p_iterator,
                                  const fungeSpaceHashKey **pp_key, size_t *size)
{
...
void *ght_first(ght_hash_table_t *p_ht,
                ght_iterator_t *p_iterator, const fungeSpaceHashKey **pp_key)
{
	return first_keysize(p_ht, p_iterator, pp_key, NULL);
}

FUNGE_ATTR_FAST
static inline void *next_keysize(ght_iterator_t *p_iterator,
                                 const fungeSpaceHashKey **pp_key, size_t *size)
{
